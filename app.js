...
var DAYS = [
  { id: 1, name: "Glutes Heavy", emoji: "🍑", tag: "Hip Thrust Focus", color: "#ff6eb4",
    exercises: [
      ...
      { id: "1g", name: "Seated Hip Abduction machine", sets: "4 × 15-20", note: "SHELF builder. Lean your torso forward ~30° — this shifts the load to the upper glute fibres (glute med/min) that cap the top corner. Different angle from Day 6's standing cable, so they stack rather than repeat. Slow, no bouncing the stack.", progression: "double" },
