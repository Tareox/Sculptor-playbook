...
var DAYS = [
  { id: 1, name: "Glutes Heavy", emoji: "🍑", tag: "Hip Thrust Focus", color: "#ff6eb4",
    exercises: [
      { id: "1a", name: "Barbell Hip Thrust", sets: "5 × 8-10", note: "PRIMARY. 2-sec hold at top. Add weight when you hit 10 across all sets.", progression: "double" },
      ...
      { id: "1c", name: "Romanian Deadlift", sets: "4 × 8-10", note: "Hip hinge. Push the floor back, feel the stretch in hamstrings.", progression: "double" },
      { id: "1d", name: "DB Step-Up high box", sets: "4 × 10/leg", note: "Shelf builder. No push-off. 3-sec descent.", progression: "double" },
  ...
  { id: 2, name: "Back", emoji: "🏗️", tag: "Width + Thickness", color: "#c084fc",
    exercises: [
      ...
      { id: "2d", name: "Single-Arm DB Row", sets: "3 × 10-12/side", note: "Heavy. Use a strap. Full stretch at bottom.", progression: "double" },
  ...
  { id: 3, name: "Shoulders + Abs", emoji: "💎", tag: "All 3 Heads", color: "#f472b6",
    exercises: [
      ...
      { id: "3d", name: "Arnold Press", sets: "3 × 10-12", note: "Front + side in one. Full rotation.", progression: "double" },
  ...
  { id: 4, name: "Glutes Hinge", emoji: "🍑", tag: "Deadlift Focus", color: "#e879f9",
    exercises: [
      ...
      { id: "4c", name: "Lateral Step-Up high box", sets: "4 × 10/leg", note: "Sideways step. Targets glute med — the shelf.", progression: "double" },
  ...
  { id: 5, name: "Back + Abs", emoji: "🏗️", tag: "Volume Day", color: "#a78bfa",
    exercises: [
      ...
      { id: "5c", name: "Cable Row neutral grip", sets: "4 × 12", note: "Mid-back focus. Pull elbows to hips.", progression: "double" },
  ...
  { id: 6, name: "Shoulders + Arms", emoji: "💪", tag: "V-Taper Builder", color: "#fb7185",
    exercises: [
      { id: "6a", name: "Standing OHP barbell or DB", sets: "4 × 6-8", note: "PRIMARY pressing. Heavier than Day 3. Standing.", progression: "double" },
      { id: "6b", name: "Cable Lateral Raise", sets: "5 × 12-15", note: "Second hit of the week. High volume for delts.", progression: "double" },
      { id: "6c", name: "Cable Upright Row wide grip", sets: "3 × 12", note: "Side delt focus. Flared elbows.", progression: "double" },
      { id: "6d", name: "Rear Delt Cable Fly", sets: "4 × 15", note: "Second rear delt hit of week.", progression: "single" },
      { id: "6e", name: "Incline DB Curl", sets: "4 × 10-12", note: "Long head bicep — most visible.", progression: "double" },
      { id: "6f", name: "Cable Hammer Curl rope", sets: "3 × 12", note: "Brachialis = thicker arms.", progression: "double" },
      { id: "6g", name: "Overhead Cable Tricep Extension", sets: "4 × 10-12", note: "Long head tricep — arm shape.", progression: "double" },
      { id: "6h", name: "Cable Pushdown", sets: "3 × 12-15", note: "Tricep finisher. Drop sets optional.", progression: "double" },
      { id: "6i", name: "20 min cardio finisher", sets: "20 min", note: "Light steady state." },
    ],
  },
];

// Lean bulk macros — single daily target (no cycling on a bulk)
// TDEE: 2,290 kcal | +310 kcal surplus = 2,600 daily
var MACROS_TARGET = { calories: 2600, protein: 140, carbs: 360, fat: 70 };
    ...
    view === "home" && React.createElement("div", { style: S.page },
      React.createElement("div", { style: S.header },
        ...
        React.createElement("div", null,
          ...
          React.createElement("div", { style: S.headerSub }, "Lean Bulk · 6 Days · Glutes/Back/Shoulders"),
        ),
      ...
      React.createElement("div", { style: { marginBottom: 32 } },
        React.createElement("div", { style: Object.assign({}, S.secLabel, { marginBottom: 14 }) }, "✦ LEAN BULK NUTRITION"),
        ...
        React.createElement("div", { style: S.macroCard },
          ...
          React.createElement("div", { style: { borderTop: "1px solid #2a1a2a", paddingTop: 12, fontSize: 11, color: "#7a5a7a", lineHeight: 1.6 } },
            "+310 kcal surplus over your TDEE (~2,290). Expected gain: 0.25-0.4 kg/month. Reassess at 12-16 weeks."
          ),
        ),

        React.createElement("div", { style: S.rulesCard },
          React.createElement("div", { style: S.rulesTitle }, "✦ Lean Bulk Rules"),
          [
            { icon: "🥩", rule: "Protein every meal", detail: "140g daily, spread across 4-5 meals. 30-40g per meal max for absorption." },
            { icon: "🍚", rule: "Carbs power your sessions", detail: "360g daily — most around training. 60-100g pre-workout, 60-100g post." },
            { icon: "🥑", rule: "Fat at 70g minimum", detail: "Hormones and recovery. Avocado, olive oil, eggs, fatty fish." },
            { icon: "⚖️", rule: "Track weight weekly, not daily", detail: "Same time, same conditions. Aim for 0.25-0.4 kg gain per month." },
            { icon: "📸", rule: "Progress photos every 4 weeks", detail: "More useful than the scale. You'll see shape changes the mirror misses." },
            { icon: "💧", rule: "Hydrate hard on a bulk", detail: "3+ litres daily. Carbs hold water — this is normal and healthy." },
            { icon: "👟", rule: "Maintain 10K steps", detail: "Helps partition calories into muscle, not fat. Don't drop activity on a bulk." },
            { icon: "🛌", rule: "Sleep is muscle growth", detail: "8+ hours. You build muscle while sleeping, not while lifting." },
          ].map(function(r) {
      ...
      React.createElement("div", { style: S.tip }, "Recommended split: Mon Glutes / Tue Back / Wed Shoulders+Abs / Thu Glutes Hinge / Fri Back+Abs / Sat Shoulders+Arms. Sunday rest."),
    ),
